...
class ListPage extends Component {
  ...
  render() {
    return (
      <div className="App">
        <h1>字頻列表</h1>
        KDB名稱：<input id="inputKDBS" value={this.state.kdbs} onChange={this.handleChangekdbs}/>
        PB ID：<input id="inputPBS" value={this.state.pbs} onChange={this.handleChangepbs}/>
